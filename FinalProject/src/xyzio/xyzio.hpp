...
namespace finprj
{
    ...
    public:
        ...
        /// @brief Export the 3D xyz point coordinates into a text file.
        /// @param filePath Path to the output file.
        /// @param coors 3D coordinates of each point.
        /// @return Whether the operation is successful.
        static bool write_xyz(const fs::path &filePath, const std::vector<cv::Point3d> &coors);
...
template<> class cv::DataType<finprj::XyzIo::Coor2D<float>>
{
public:
...
template<> class cv::DataType<finprj::XyzIo::Coor2D<double>>
{
public:
...
template<> class cv::DataType<finprj::XyzIo::Coor3D<float>>
{
public:
    typedef float       value_type;
    typedef value_type  work_type;
...
template<> class cv::DataType<finprj::XyzIo::Coor3D<double>>
{
public:
    typedef double      value_type;
    typedef value_type  work_type;
