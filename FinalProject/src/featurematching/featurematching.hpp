...
namespace finprj
{
    ...
    public:
        ...
        static cv::Mat draw_matching_points(const cv::Mat &image, const std::list<const cv::Point*>& pointsLeft_ptrs, const std::list<const cv::Point*>& pointsRight_ptrs);
        ...
        static void filter_nonmatching_points(const cv::Mat_<cv::Point> &pointLeft, const cv::Mat_<cv::Point> &pointRight, std::list<const cv::Point *> &out_validPointLeft, std::list<const cv::Point *> &out_validPointRight, size_t& out_validPointCount);
