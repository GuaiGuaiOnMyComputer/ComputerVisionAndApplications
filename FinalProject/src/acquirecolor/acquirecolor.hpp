...
namespace finprj
{
    ...
    public:
        ...
        static std::vector<XyzIo::Rgb_ui8> get_rgb_from_right_image(const cv::Mat &projectionMatrixRight, const cv::Mat &rightImage, const std::forward_list<const cv::Point3d*>& worldPoints);
